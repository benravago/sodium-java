...
/**
 * A cell that allows values to be pushed into it, acting as an interface between the world of I/O and the world of FRP.
 * Code that exports CellSinks for read-only use should downcast to {@link Cell}.
 */
