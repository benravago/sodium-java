...
public class StreamSink<A> extends StreamWithSend<A> {
  ...
  public StreamSink() {
    this((l, r) -> {
      throw new IllegalStateException("send() called more than once per transaction");
      // which isn't allowed. Did you want to combine the events? Then pass a combining function to your StreamSink constructor.
    });
  }
   ...
   * @param f Function to combine the values. It may construct FRP logic or use {@link Cell#sample()}.
